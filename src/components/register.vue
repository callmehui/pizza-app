<template>
    <div class="row mt-3">
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <div class="card-body">
                    <img class="mx-auto d-block" src="../assets/pan.png" alt="">
                    <form @submit.prevent="onSubmit">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" required class="form-control" v-model="confirmPassword">   
                        </div>
    ...
    methods: {
        onSubmit(){
            ...
            if( this.password === this.confirmPassword ){
                ...
                // 向firebase的database创建数据
                let dbUsers = firebase.database().ref().child('users');
                console.log( dbUsers.set(formData) );
                alert("注册成功");
            } else {
                alert("两次密码不一致！");
            }
